[[https://github.com/ROCKTAKEY/pc-separate][https://img.shields.io/github/tag/ROCKTAKEY/pc-separate.svg?style=flat-square]]
...
* How to Use?
  ...
  :CUSTOM_ID: HowToUse
  :END:
  Set your definition of separator into =ss-separator-alist= (optional),
  and use =ss-setq= or =ss-cond=.
...
** Symbol
   - This is interpreted as =separator= defined in =ss-separator-alist=,
   or system-type (same as =:os= keyword). See [[#ss-separator-alist][ss-separator-alist Section]].
...
#+BEGIN_SRC emacs-lisp -n
  ...
  (
   ...
   ;; `ss-separator-alist'. So you can write this instead of above.
